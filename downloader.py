# Auto-ported from working Clipador app into a Flask blueprint.
import os
import uuid
import threading
import subprocess
...
WORK_DIR = Path("/tmp/creativify/downloader")
...
@bp.route("/")
def index():
    return render_template("downloader.html", sites=SUPPORTED_SITES)
...
@bp.route("/api/download-all/<session_id>")
